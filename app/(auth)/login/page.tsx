          ...
          <div className="w-full max-w-sm">
            ...
            >
              <label className="grid gap-2">
                ...
                <div className="flex h-12 items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 focus-within:border-[#7569ff] focus-within:ring-4 focus-within:ring-indigo-50">
                  <Mail
                    size={18}
